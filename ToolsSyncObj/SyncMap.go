...
// SyncMap is a concurrent map with amortized-constant-time loads, stores, and deletes.
// It is safe for multiple goroutines to call a SyncMap's methods concurrently.
//
